...
$music = rand("5","2688");
if($text == "اغنيه" or $text == "غنيلي"){bot('sendvoice',['chat_id'=>$chat_id,'voice'=>"https://t.me/AudioDragon/$music",'caption'=>"تم اختيار اغنيه عشوائيه",'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"مره اخرى","callback_data"=>"voiceag"]],]])]);}
if($data == "voiceag"){bot('sendvoice',['chat_id'=>$chat_id,"message_id"=>$message_id,'voice'=>"https://t.me/AudioDragon/$music",'caption'=>"تم اختيار اغنيه عشوائيه",'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"مره اخرى ","callback_data"=>"voiceag"]],]])]);}

if($text == "/start" && $type == "private"){
bot('sendmessage',[
'chat_id'=>$chat_id,
'parse_mode'=>"MarkDown",
'text'=>"❍ أهلاً وسهلاً بك عزيزي في بوت غنيلي",
]);}