...
bot('sendMessage',[
 'chat_id'=>$chat_id, 
  'text'=>" • اهلا عزيزي ( [$nx1$nx2](tg://user?id=$id) ) في بوت قياس قوه تقبيلك 💋

- يمكنك قياس قوه تقبيلك انت ! عن طريق الضغط على الزر 

- ويمكنك قياس قوه تقبيل شخص لك عن طريق ضغط على زر قياس قوه تقبيل شخص لك 🥰 ",
'parse_mode'=>"markdown",'disable_web_page_preview'=>true,"reply_markup"=>json_encode(["inline_keyboard"=>[
[['text'=>'قياس قوه تقبيلك','callback_data'=>"st1"]],
]])]);}
if($data=="start"){
bot('editMessageText',[
 'chat_id'=>$chat_id, 
...
bot('editMessageText',[
 'chat_id'=>$chat_id, 
 'message_id'=>$message_id,
'text'=>"• قم بتقبيل الازرار ادناه . ",
'parse_mode'=>"markdown",'disable_web_page_preview'=>true,"reply_markup"=>json_encode(["inline_keyboard"=>[
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
[['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"]],
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'💋','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
[['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"],['text'=>'ㅤ','callback_data'=>"tak"]],
]])]);}

$taq = file_get_contents("https://api-jack.ml/api1.php");
if($data=="tak"){
bot('editMessageText',[
 'chat_id'=>$chat_id,
 'message_id'=>$message_id,
