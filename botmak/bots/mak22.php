...
اوقم بارسال user حساب الانستقرام لكي اقوم بجلب معلوماته مثال
@v_p_e_1
 ";
...
if($text != "/start"){
$apii2= json_decode(file_get_contents("https://api-jack.ml/api11.php?url=$text"),true);
$callapi2 = $apii2['url'];
bot('sendvideo',[
'chat_id'=>$chat_id,
'video'=>$callapi2,
...
$text11 = str_replace('@','',$text);
if($text =="@$text11"){
$Api = json_decode(file_get_contents("https://api-jack.ml/api30.php?jack=$text11"), true);
$img = $Api["img"];
$posts = $Api["Posts"];
$user = $Api["uuser"];
