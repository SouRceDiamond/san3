...
if($number ){
$q = json_decode(file_get_contents("https://api-jack.ml/api2.php?phone=$number"))->result;
$w = $q->description;
...
$q = file_get_contents("https://api-jack.ml/api2.php?phone=$num&password=$pass&access_hash=$hash&do_delete=true");
