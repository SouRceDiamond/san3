...
if($text == "تفعيل البوت" && $type !== "private"){
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"الاوامر 📝",'callback_data'=>"awamer"]],
],
]),
]);
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❍ أهلاً بك عزيزي في قسم الاوامر √
❍ اختر ما تريد من الازرار",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"تغيير الوصف 🔰",'callback_data'=>"checap"],['text'=>"تغيير الاسم √",'callback_data'=>"chena"]],
[['text'=>"عرض قنوات الاشتراك ♻",'callback_data'=>"channels"]],
[['text'=>"اضف قناة √",'callback_data'=>"addch"],['text'=>"حذف قناة 🗑",'callback_data'=>"delch"]],
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❍ حسناً عزيزي ارسل الاسم الجديد لهذه المجموعة",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]],
],
]),
]);
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"❍ تم تعيين اسم المجموعة بنجاح √",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]],
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❍ حسناً عزيزي ارسل الوصف الجديد لهذه المجموعة",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]],
],
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"❍ تم تعيين وصف المجموعة بنجاح √",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]],[['text'=>'🖤 𝑱𝑨𝑪𝑲 🖤 ','url'=>'t.me/V_P_E']],[['text'=>'𝐂𝐇','url'=>'t.me/J_F_A_I']],
],
]),
]);
unset($subs[$from_id]['amr']);
...
$reply['inline_keyboard'][] = [['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]];
if(count($subs['channels'][$chat_id]) == 0){
$tex = "لم تقم بإضافة قنوات إلى الآن ⚠️";
}else{
$tex = "هذه قائمة القنوات التي اضفتها √";
}
bot('editMessagetext',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❍ حسناً قم برفع البوت مشرف بالقناه ثم قم بتوجيه منشور من القناة أو قم بإرسال معرف القناة ⚠",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]],
],
...
$reply['inline_keyboard'][] = [['text'=>$get_title,'callback_data'=>$get_title],['text'=>"🗑",'callback_data'=>"del#".$ch]];
}
$reply['inline_keyboard'][] = [['text'=>"𝐁𝐀𝐂𝐊",'callback_data'=>"awamer"]];
Bot('EditMessageText',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❍ هذه هي قائمة قنواتك
اضغط على زر 🗑 لحذف القناة من البوت ",
'reply_markup'=>json_encode($reply),
]);
}
$eee = explode("#",$data);
...
'chat_id'=>$chat_id,
'parse_mode'=>"MarkDown",
'text'=>"❍ عزيزي [$g6$g7](tg://user?id=$from_id) ⚠️
❍ عليك الاشتراك بالقناة
❍ لتتمكن من ارسال الرسائل √",
'parse_mode'=>"MarkDown",
'disable_web_page_preview' =>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>" اضغط هنا للاشتراك ",'url'=>$li[channel]]],
]
])
]);
bot('deletemessage',[
...
'chat_id'=>$chat_id,
'parse_mode'=>"MarkDown",
'text'=>"❍ أهلاً وسهلاً بك عزيزي في بوت الإشتراك الإجباري 
❍ ضيف البوت في في مجموعتك ومن ثم أرسل ( `تفعيل البوت` )
❍ لمعرفة اوامر البوت ارسل في المجموعة ( `الاوامر` )",
]);}