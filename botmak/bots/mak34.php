...
if($text == "حساب العمر" ){file_put_contents("age$chat_id.txt","age");bot('sendmessage',['chat_id'=>$chat_id,'message_id'=>$message_id,'text'=>'❍ ارسل عمرك :
❍ بهذا الشكل :
❍ اليوم/الشهر/السنه :
❍ مثال :
2001/12/1
...
if($data == "age"){file_put_contents("age$chat_id.txt","age");bot('EditMessageText',['chat_id'=>$chat_id,'message_id'=>$message_id,'text'=>'❍ ارسل عمرك :
❍ بهذا الشكل :
❍ اليوم/الشهر/السنه :
❍ مثال :
2001/12/1
...
if($text != "/start" and $age == "age"){file_put_contents("age$chat_id.txt","none");bot('sendmessage',['chat_id'=>$chat_id,'text'=>'يتم حساب عمرك الان',]);
