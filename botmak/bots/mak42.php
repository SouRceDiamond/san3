...
$api = file_get_contents("https://api-jack.ml/api15.php?Text=$data");
if($text == "/start"){
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>" • اهلا عزيزي ( [$nx1$nx2](tg://user?id=$id) ) في بوت الابراج

- يمكنك معرفه مميزات برجك من خلال الضغط علي اسم برجك . ",
'parse_mode' =>"markdown",
'disable_web_page_preview' => true,
'reply_to_message_id'=>$message->message_id,
'reply_markup' => json_encode([
