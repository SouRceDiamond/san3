...
☑️| في قناة البوت اولا $link_ch_sudo1
...
sendaction($chat_id, typing);
        bot('sendmessage', [
                'chat_id' => $chat_id,
                'text' =>"
مرحبا، بك في بوت رفع الملفات ♻️
ارسل لي الان اي نوع من الميديا 🔖
لكي يتم رفعة برابط مباشر للتحميل
",
            ]);
        }
