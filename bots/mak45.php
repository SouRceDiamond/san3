...
bot('sendMessage',[
 'chat_id'=>$chat_id, 
 'message_id'=>$message_id,
  'text'=>" • اهلا عزيزي  [$nx1$nx2](tg://user?id=$id)  في تحميل الميديا
  ـ يمكنك التحميل من خلال ارسال الرابط فقط
  - قم بأرسال رابط الميديا .",
'parse_mode' =>"markdown",
'disable_web_page_preview' => true,
'reply_to_message_id'=>$message->message_id,]);
}
