...
- في افضل بوت ترجمه علي الاطلاق

- يمكنك الترجمه بعدة لغات من خلال البوت
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'بدء الترجمة ' ,'callback_data'=>"startT"]],
]
])
]);
}
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'من الانجليزيه للعربية' ,'callback_data'=>"enTOar"]],
[['text'=>'من العربية للانجليزية' ,'callback_data'=>"arTOen"]],
[['text'=>'من الفارسية للعربية' ,'callback_data'=>"faTOar"]],
[['text'=>'من العربية للفارسية' ,'callback_data'=>"arTOfa"]],
[['text'=>'من الروسية للعربية' ,'callback_data'=>"ruTOar"]],
[['text'=>'من العربية للروسية' ,'callback_data'=>"arTOru"]],
[['text'=>'من الهندية للعربية' ,'callback_data'=>"hiTOar"]],
[['text'=>'من العربية للهندية' ,'callback_data'=>"arTOhi"]],
[['text'=>'من المانية للعربية' ,'callback_data'=>"deTOar"]],
[['text'=>'من العربية للالمانية' ,'callback_data'=>"arTOde"]],
]
])
]);
}
$get_trgma=file_get_contents('trgm.txt');
if($data=="enTOar"){
bot('editmessagetext',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من الانجليزيه للعربية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","enTOar");
}
if ($get_trgma=="enTOar"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=en&to=ar&text=$text"),true);
bot("SendMessage",[
"chat_id"=>$chat_id,
"text"=>" 
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من العربية للانجليزية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","arTOen");
}
if ($get_trgma=="arTOen"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ar&to=en&text=$text"),true);
bot("SendMessage",[
"chat_id"=>$chat_id,
"text"=>" 
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من الفارسية للعربية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","faTOar");
}
if ($get_trgma=="faTOar"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=fa&to=ar&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من العربية للفارسية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","arTOfa");
}
if ($get_trgma=="arTOfa"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ar&to=fa&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من الروسية للعربية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","ruTOar");
}
if ($get_trgma=="ruTOar"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ru&to=ar&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من العربية للروسية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","arTOru");
}
if ($get_trgma=="arTOru"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ar&to=ru&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من الهندية للعربية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","hiTOar");
}
if ($get_trgma=="hiTOar"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=hi&to=ar&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من العربية للهندية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","arTOhi");
}
if ($get_trgma=="arTOhi"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ar&to=hi&text=$text"),true);
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من الالمانية للعربية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","deTOar");
}
if ($get_trgma=="deTOar"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=de&to=ar&text=$text"),true);

bot("SendMessage",[
"chat_id"=>$chat_id,
"text"=>" 
*من الالمانية للعربية*
تم الترجمه : $js
...
'message_id'=>$message_id,
'text'=>"
حسنا اخترت من العربية للالمانية ✅
ارسل الكلمة لترجمتها ⬇
",
'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
]);
file_put_contents("trgm.txt","arTOde");
}
if ($get_trgma=="arTOde"){
$js = json_decode(file_get_contents("https://api-jack.ml/api35.php?from=ar&to=de&text=$text"),true);

bot("SendMessage",[
"chat_id"=>$chat_id,
"text"=>" 
*من العربية للالمانية*
تم الترجمه : $js
