...
bot('sendMessage',[
 'chat_id'=>$chat_id, 
  'text'=>" • اهلا عزيزي ( [$nx1$nx2](tg://user?id=$id) ) في بوت معاني الاسماء

- يمكنك معرفه معني اسمك من خلال ارسال كلمه معني + اسمك مثال `معني صلاح`",
'parse_mode' =>"markdown",
'disable_web_page_preview' => true,
'reply_to_message_id'=>$message->message_id,]);}
 
$text2 = str_replace('معني ','',$text);
if($text =="معني $text2"){
$api5 = file_get_contents("https://api-jack.ml/api5.php?name=$text2");
bot('sendphoto',[
'chat_id'=>$chat_id, 
'photo'=>"https://www.meaningnames.net?name=$text2",
'message_id'=>$message_id,
'caption'=>$api5,
'parse_mode' =>"markdown",
'disable_web_page_preview' => true,
